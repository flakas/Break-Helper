$(document).ready(function(){
	...
	$("#lastBreak").html(lastBreak.getFullYear() + '/' + lastBreak.getMonth() + '/' + lastBreak.getDate() + ' ' + lastBreak.getHours() + ':' + lastBreak.getMinutes() + ':' + lastBreak.getSeconds());      
